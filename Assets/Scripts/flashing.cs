...
public class flashing : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < numSphere; i++)
        {
            ...
            spheres[i].transform.localScale = new Vector3(Random.Range(1f, 1f), Random.Range(1f, 1f), Random.Range(1f, 1f));
            // Color
...
for (int i = 0; i < numSphere; i++)
{
    ...
    if(changeShape && time < 0.3f)
            {
                spheres[i].transform.position = position1[i];
            } 

    if(!changeShape && time < 0.3f)
            {
                spheres[i].transform.position = position2[i];
            }
